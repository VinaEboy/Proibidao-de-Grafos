...
\begin{enumerate}[label=\textbf{\arabic*.}, ref=\arabic*]
    ...
    \begin{quote}
        ...
        Base: Para $n=0$, $\Gamma_{G}^{0}(\emptyset) = \emptyset$ por definição. \\
        Hipótese de indução: Suponha que $\Gamma_{G}^{k}(\emptyset) = \emptyset$ seja válido para um inteiro arbitrário $k$ no intervalo $k \ge 0$. \\
        Passo indutivo: Queremos provar que a afirmação vale para $k+1$. Pela definição da recorrência, temos que $\Gamma_{G}^{k+1}(\emptyset) = \Gamma_{G}(\Gamma_{G}^{k}(\emptyset))$. Usando a hipótese da indução porque $k$ pertence ao intervalo da hipótese ($k \ge 0$), podemos substituir $\Gamma_{G}^{k}(\emptyset)$ por $\emptyset$. Logo, obtemos $\Gamma_{G}(\emptyset) = \emptyset$.
    \end{quote}
        ...
        \begin{quote}
            ...
            Base: Para $n=0$ (par), $\Gamma_G^0(\{1\}) = \{1\}$. Para $n=1$ (ímpar), $\Gamma_G^1(\{1\}) = \Gamma_G(\{1\}) = \{2\}$. \\
            Hipótese de indução: Suponha que, para um inteiro arbitrário $k$ no intervalo $k \ge 0$, seja válido que $\Gamma_G^k(\{1\}) = \{1\}$ se $k$ for par, e $\Gamma_G^k(\{1\}) = \{2\}$ se $k$ for ímpar. \\
            Passo indutivo: Queremos provar que a afirmação vale para $k+1$. Por definição, $\Gamma_G^{k+1}(\{1\}) = \Gamma_G(\Gamma_G^k(\{1\}))$. Temos dois casos a analisar:
            \begin{itemize}
                \item Caso $k+1$ seja ímpar: Então $k$ é par. Usando a hipótese da indução porque $k$ pertence ao intervalo da hipótese, substituímos $\Gamma_G^k(\{1\})$ por $\{1\}$. Aplicando a função, obtemos $\Gamma_G(\{1\}) = \{2\}$.
                \item Caso $k+1$ seja par: Então $k$ é ímpar. Usando a hipótese da indução porque $k$ pertence ao intervalo da hipótese, substituímos $\Gamma_G^k(\{1\})$ por $\{2\}$. Aplicando a função, obtemos $\Gamma_G(\{2\}) = \{1\}$.
            \end{itemize}
